...
import cutiemewmew.MewMewModchartController;
...
var mewModchart:MewMewModchartController;
...
function postCreate()
{
    ...
    mewModchart = new MewMewModchartController();
    mewModchart.setup();
    setAllStrumSpeeds(noteSpeedStart);
}
...
function onUpdate(elapsed:Float)
{
    ...
    if (mewModchart != null)
        mewModchart.update(introActive);
    resizeVideo();
    resizeOverlay();
    layoutHealthBar();
    updateStackedScoreText();
